...
insert into sys_menu values(2006, '约战排表', 1065, 3, 'schedule', 'guild/schedule/index', '', '', 1, 0, 'C', '0', '0', 'guild:schedule:list', 'table', 'system', current_timestamp, 'system', current_timestamp, '约战排表');
